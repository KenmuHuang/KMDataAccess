...
- (void)layoutUI {
    self.navigationItem.title = kTitleOfCoreData;
    ...
    NSMutableArray *mArrGlobalInfo = [[CoreDataGlobalInfoService sharedService] getGlobalInfoGroup];
    ...
    _tableView = [[KMTableView alloc] initWithGlobalInfoArray:mArrGlobalInfo
                                           ...
                                           cellConfigureBlock:^(KMTableViewCell *cell,
                                            ...
                                            didDelectRowBlock:^(NSNumber *ID){
                                                [[CoreDataGlobalInfoService sharedService] deleteGlobalInfoByID:ID];
                                            }];
    [self.view addSubview:_tableView];
}

- (void)reloadData {
    _tableView.mArrGlobalInfo = [[CoreDataGlobalInfoService sharedService] getGlobalInfoGroup];
